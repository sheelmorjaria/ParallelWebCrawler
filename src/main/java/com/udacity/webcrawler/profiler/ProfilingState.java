...
final class ProfilingState {
   ...
   * @param l      the amount of time that passed while the method was called.
   */
  void record(Class<?> callingClass, Method method, Duration l) {
    ...
    data.compute(key, (k, v) -> (v == null) ? l : v.plus(l));
  }
